...
if (results[0].label == "Entry Accepted") { document.getElementById("update_emoji").innerHTML = "&#x1F637;"; }
if (results[0].label == "Entry Denied") { document.getElementById("update_emoji").innerHTML = "&#x26d4;"; }
    }
 }
